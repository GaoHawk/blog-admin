			...
			<section class="content-container">
				<div class="grid-content bg-purple-light">
					<el-col :span="24" class="breadcrumb-container">
						<strong class="title" v-if="$route.query.articleId">修改文章</strong>
						<strong class="title" v-else>{{$route.name}}</strong>
						<el-breadcrumb separator="/" class="breadcrumb-inner">
							<el-breadcrumb-item v-for="item in $route.matched" :key="item.path">
							  <span v-if="$route.query.articleId && item.name =='添加文章'">修改文章</span>
	...
	export default {
		...
		methods: {
			...
			collapse:function(){
				...
				this.$nextTick(() =>{
					let elm = document.querySelector('ul.el-menu.el-menu-vertical-demo')
