  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="footer">
        ...
        <el-popover ref="submit" placement="top" width="160" v-model="visible2">
    ...
    <el-dialog title="标签分类" :visible.sync="dialogTableVisible2" id="tags">
      ...
      <el-tag :key="tag.name" v-for="tag in tags" :closable="true" :close-transition="false" @close="handleClose(tag.name)">
      ...
      getValue() {
        ...
        axios.get("/api/articleDetial", {
          ...
          if (res.status == "0") {
            ...
            this.form.tag = res.result.tag
            this.form.describtion = res.result.describtion
